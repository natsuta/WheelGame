 ...
 * 
 * This is a modified version of the simple test client for testing purposes.
 * The code will be assessed using said client.
 * 
...
//      int enumOrdinal = 0;
      for (Player player : players)
      {
         ...
         gameEngine.placeBet(player, 100, BetType.values()[0]);
      }
